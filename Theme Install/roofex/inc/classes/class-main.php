...
if (!class_exists('Roofex_Main')) { 
    class Roofex_Main extends roofex_Base
    {
...
function roofex() {
    return Roofex_Main::getInstance();
}
// Install
roofex(); 
