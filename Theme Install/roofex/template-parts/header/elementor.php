<?php 
$logo_m = roofex()->get_theme_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
$p_menu = roofex()->get_page_opt('p_menu');
$sticky_scroll = roofex()->get_theme_opt('sticky_scroll');
...
$header_layout = roofex()->get_opt('header_layout');
                ...
                <div class="row">
                    ...
                    <div class="pxl-header-menu">
                        <div class="pxl-header-menu-scroll">
                            ...
                            <?php roofex_header_mobile_search_form(); ?>
