...
if(isset($settings['pricing']) && !empty($settings['pricing']) && count($settings['pricing'])): ?>
    <div class="pxl-swiper-sliders pxl-pricing-carousel pxl-pricing-carousel1 <?php echo esc_attr($settings['style']); ?> " data-view-auto="<?php echo esc_attr($col_xl); ?>" data-show-arrow="<?php echo esc_attr($arrows); ?>">
        <div class="pxl-carousel-inner">
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    <?php foreach ($settings['pricing'] as $key => $value):
                                ...
                                <div class="pxl-item--inner <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
                                    ...
                                    <div class="pxl-item--holder">
                                        ...
                                        <div class="pxl-item--price">
                                            <span class="pxl-item--unit"><?php echo pxl_print_html($unit); ?></span>
                                            <span class="pxl-item--pricing"><?php echo pxl_print_html($price); ?></span>
                                        </div>
                                    </div>
                                </div>
