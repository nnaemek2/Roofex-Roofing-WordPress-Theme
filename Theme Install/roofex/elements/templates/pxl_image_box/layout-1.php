...
<div class="pxl-image-box pxl-image-box1  <?php echo esc_attr($settings['style']); ?> <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-item--inner">
        ...
        <div class="wrap-content">
            ...
            <?php if(!empty($settings['btn_text'])) : ?>
                <div class="pxl-item--button"><a class="btn-more" <?php pxl_print_html($widget->get_render_attribute_string( 'btn_link' )); ?>><span><?php echo esc_attr($settings['btn_text']); ?></span></a></div>
            <?php endif; ?>
        </div>
    </div>
</div>