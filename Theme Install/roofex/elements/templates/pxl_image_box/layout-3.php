...
<div class="pxl-image-box pxl-image-box3 <?php echo esc_attr($settings['pxl_animate']); ?> <?php echo esc_attr($settings['style']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-item--inner">
        ...
        <?php if(!empty($settings['btn_text'])) : ?>
            <div class="pxl-item--button"><a class="btn-more" <?php pxl_print_html($widget->get_render_attribute_string( 'btn_link' )); ?>><span><?php echo esc_attr($settings['btn_text']); ?></span><i class="caseicon-long-arrow-right-two"></i></a></div>
        <?php endif; ?>
    </div>
</div>