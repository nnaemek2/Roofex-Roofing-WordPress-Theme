...
<div class="pxl-swiper-sliders pxl-team pxl-team-carousel2 pxl-swiper-arrow-style4" data-cursor-label="Drag">
                    ...
                    <div class="pxl-swiper-slide">
                        <div class="pxl-item--inner <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
                            ...
                            <div class="pxl-item--holder">
                             <div class="phone-nb">
                                <i class="flaticon-telephone-call"></i><span>Phone:</span><?php if ( ! empty( $link_phone['url'] ) ) { ?><a <?php echo implode( ' ', [ $link_phone_attributes ] ); ?>><?php } ?>
