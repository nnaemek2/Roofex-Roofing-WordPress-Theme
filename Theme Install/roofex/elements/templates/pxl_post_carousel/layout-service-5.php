...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-service-carousel pxl-service-carousel5 pxl-swiper-nogap <?php if($arrows == true) { echo 'pxl-arrows-active'; } ?>">
            ...
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    ...
                    $service_icon_img = get_post_meta($post->ID, 'service_icon_img', true);
                        $image_size = !empty($img_size) ? $img_size : '740x536';
                        ...
                        if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)): ?>
                            <div class="pxl-swiper-slide">
                                <div class="pxl-item--inner <?php echo esc_attr($pxl_animate); ?>" >
                                    <div class="pxl-item--holder"  <?php if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)) { $thumbnail_url = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'full'); ?>style="background-image: url(<?php echo esc_url($thumbnail_url[0]); ?>);"<?php } ?>>
                                   ...
                                   <div class=" hover <?php echo esc_attr($pxl_animate); ?>">
                                    <div class="pxl-item--hover">
                                    ...
                                    <?php if($show_button == 'true' && !empty($show_button)): ?>
                                        <div class="pxl-readmore">
                                            <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><span>Read More</span></a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
    ...
    <?php if($arrows !== 'false'): ?>
        <div class="pxl-swiper-arrow-wrap">
            <div class="pxl-swiper-arrow pxl-swiper-arrow-prev"><i class="flaticon-arrow"></i></div>
            <div class="pxl-swiper-arrow pxl-swiper-arrow-next"><i class="flaticon-right-arrow"></i></div>
        </div>
    <?php endif; ?>
