        ...
        <div class="pxl-carousel-inner">
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    <?php
                    $image_size = !empty($img_size) ? $img_size : '370x366';
                                ...
                                <div class="pxl-item--image hover-imge-effect3">
                                    ...
                                    <?php if($show_date == 'true' ) : ?>
                                        <div class="pxl-item--date ">
                                            <div class="day"><?php $date_formart = get_option('date_format'); echo get_the_date('d', $post->ID); ?></div>
                                            <div class="month"><?php $date_formart = get_option('date_format'); echo get_the_date('M', $post->ID); ?></div>
                                        </div>
