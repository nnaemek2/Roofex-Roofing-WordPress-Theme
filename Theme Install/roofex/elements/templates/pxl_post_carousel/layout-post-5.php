...
<?php if (is_array($posts)): ?>
	<div class="pxl-swiper-sliders pxl-post-carousel pxl-post-carousel5 pxl-swiper-boxshadow">
							...
							<div class="pxl-item--inner <?php echo esc_attr($pxl_animate); ?>" data-wow-duration="1.2s">
								...
								<div class="content">
									...
									<div class="pxl-item--date ">
										...
										<?php $date_formart = get_option('date_format'); echo get_the_date('F d,Y', $post->ID); ?>                                          
									</div>
								<?php endif; ?>
