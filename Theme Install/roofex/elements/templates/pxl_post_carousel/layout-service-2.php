...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-service-carousel <?php echo esc_attr($settings['style']); ?> pxl-service-carousel2 pxl-swiper-nogap <?php if($arrows == true) { echo 'pxl-arrows-active'; } ?>">
