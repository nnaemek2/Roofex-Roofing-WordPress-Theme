...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-portfolios-carousel pxl-portfolio-carousel3 pxl-swiper-nogap <?php echo esc_attr($settings['style']); ?> <?php if($arrows == true) { echo 'pxl-arrows-active'; } ?>">
            ...
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    ...
                    foreach ($posts as $post):
                        ...
                        $image_size = !empty($img_size) ? $img_size : '836x836';
                                    ...
                                    <div class="pxl-item--holder" data-tilt-scale="1.2" >
                                        ...
                                        <h3 class="pxl-item--title">
                                            <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
                                                <span><?php echo wp_trim_words( get_the_title($post->ID), 5, '' ); ?></span>
                                            </a>
                                        </h3>
