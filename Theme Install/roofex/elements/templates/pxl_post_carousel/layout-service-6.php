...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-service-carousel pxl-service-carousel6 pxl-swiper-nogap <?php if($arrows == true) { echo 'pxl-arrows-active'; } ?>">
                            ...
                            <div class="pxl-swiper-slide">
                                ...
                                <?php if($show_button == 'true' && !empty($show_button)): ?>
                                    <div class="pxl-readmore">
                                        <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
                                            <img class="ar1" src="<?php echo esc_url(get_template_directory_uri().'/assets/img/ar1.png'); ?>" alt="ar1">
                                            <img class="ar2" src="<?php echo esc_url(get_template_directory_uri().'/assets/img/ar2.png'); ?>" alt="ar2">
                                            <span>Read More</span> <span class="dot"></span> <i class="fas fa-chevron-right"></i>
                                        </a>
                                    </div>
                                <?php endif; ?>
                            </div>
