...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-portfolios-carousel pxl-portfolio-carousel2 pxl-swiper-nogap <?php if($arrows == true) { echo 'pxl-arrows-active'; } ?>">
            ...
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    ...
                    foreach ($posts as $post):
                        ...
                        $image_size = !empty($img_size) ? $img_size : '450x950';
