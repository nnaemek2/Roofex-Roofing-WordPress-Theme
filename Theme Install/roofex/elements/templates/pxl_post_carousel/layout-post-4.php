...
<?php if (is_array($posts)): ?>
	<div class="pxl-swiper-sliders pxl-post-carousel pxl-post-carousel4 pxl-swiper-boxshadow">
		<div class="pxl-carousel-inner">
			<div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
				<div class="pxl-swiper-wrapper">
					<?php
					$image_size = !empty($img_size) ? $img_size : '620x420';
								...
								<div class="post-meta">
									<?php if($show_date == 'true' ) : ?>
										<div class="pxl-item--date ">
											...
											<?php $date_formart = get_option('date_format'); echo get_the_date('M d,Y', $post->ID); ?>                                          
										</div>
									<?php endif; ?>
