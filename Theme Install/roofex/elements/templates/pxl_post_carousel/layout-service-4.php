...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-service-carousel pxl-service-carousel4 pxl-swiper-nogap <?php echo esc_attr($settings['style']) ?> <?php if($arrows == true) { echo 'pxl-arrows-active'; } ?>">
