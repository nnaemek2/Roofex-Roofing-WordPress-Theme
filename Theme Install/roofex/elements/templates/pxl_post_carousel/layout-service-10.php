...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-service-carousel10 <?php echo esc_attr($settings['style']); ?> pxl-swiper-nogap <?php if($arrows == true) { echo 'pxl-arrows-active'; } ?>">
                                ...
                                <div class="pxl-item--inner <?php echo esc_attr($pxl_animate); ?>">
                                    ...
                                    <?php if($show_button == 'true' && !empty($show_button)): ?>
                                        <div class="pxl-readmore">
                                            <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>">Read More <i class="flaticon flaticon-right-up"></i></a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
        ...
        <?php if($arrows !== 'false'): ?>
            <div class="pxl-swiper-arrow pxl-swiper-arrow-next"><i class="far fa-long-arrow-right"></i></div>
            <div class="pxl-swiper-arrow pxl-swiper-arrow-prev"><i class="far fa-long-arrow-left"></i></div>
        <?php endif; ?>
