...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-service-carousel pxl-service-carousel3 pxl-swiper-nogap <?php if($arrows == true) { echo 'pxl-arrows-active'; } ?>">
                            ...
                            <div class="pxl-swiper-slide">
                                ...
                                <?php if($show_button == 'true' && !empty($show_button)): ?>
                                    <div class="pxl-readmore">
                                        <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><span>Read More</span> <i class="caseicon-double-chevron-right"></i></a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
