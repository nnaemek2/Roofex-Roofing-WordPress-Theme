    ...
    <div class="pxl-item--inner">
        ...
        <div class="pxl-item--holder">
            ...
            <?php if ( ! empty( $settings['btn_text'] ) ) {
                ...
                <div class="pxl-item--link"><a <?php pxl_print_html($widget->get_render_attribute_string( 'item_link' )); ?>><?php echo esc_attr($settings['btn_text']); ?><i class="flaticon-right-arrow"></i></a></div>
            <?php } ?>
        </div>
    </div>
</div>