<div class="pxl-icon-box pxl-icon-box2 <?php echo esc_attr($settings['style_l2'].' '.$settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-item--inner">
        ...
        <div class="pxl-item--holder">
            <<?php echo esc_attr($settings['title_tag']); ?> class="pxl-item--title el-empty"><span><?php echo pxl_print_html($settings['title']); ?></span></<?php echo esc_attr($settings['title_tag']); ?>>
