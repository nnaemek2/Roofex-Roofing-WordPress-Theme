<div class="pxl-icon-box pxl-icon-box13 <?php echo esc_attr($settings['style_l2'].' '.$settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-item--inner">
        ...
        <div class="pxl-item--holder">
            ...
            <div class="pxl-item--icon">
                ...
                <div class="step">
                    <?php 
                    echo pxl_print_html($settings['step']);
                    ?>
                </div>
            </div>
        <?php endif; ?>
        ...
        <?php endif; ?>
            ...
            <<?php echo esc_attr($settings['title_tag']); ?> class="pxl-item--title el-empty"><a <?php pxl_print_html($widget->get_render_attribute_string( 'item_link' )); ?>>
