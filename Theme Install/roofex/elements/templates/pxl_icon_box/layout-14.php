<div class="pxl-icon-box pxl-icon-box14 <?php echo esc_attr($settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
    <div class="pxl-item--inner">
        ...
        <div class="pxl-item--link"><a <?php pxl_print_html($widget->get_render_attribute_string( 'item_link' )); ?>><i class="flaticon flaticon-download"></i></a></div>
    </div>
</div>