...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Pxl Video Player ', 'roofex' ),
        'icon' => 'eicon-play',
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__('Button Video Style', 'roofex' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'style1' => 'Style 1',
                                'style2' => 'Style 2',
                        ...
                        array(
                            'name' => 'btn_video_text',
                            'label' => esc_html__('Button Video Text', 'roofex' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                        ),
                        array(
                            'name' => 'btn_video_position',
                            'label' => esc_html__('Button Video Position', 'roofex' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'p-center' => 'Center',
                                'p-top-left' => 'Top Left',
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'label' => esc_html__('Button Video Text Color', 'roofex' ),
                        ...
                        array(
                            'name' => 'box_icon_color',
                            'label' => esc_html__('Box Icon Color', 'roofex' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Icon Background Color', 'roofex' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Border Radius', 'roofex' ),
