...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_team_grid',
        'title' => esc_html__('Pxl Team Grid', 'roofex'),
                        ...
                        array(
                            ...
                            'options' => [
                                ...
                                '3' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elements/templates/pxl_team_grid/layout-image/layout3.jpg'
                                ],
                                '4' => [
                                    'label' => esc_html__('Layout 4', 'roofex' ),
                                    'image' => get_template_directory_uri() . '/elements/templates/pxl_team_grid/layout-image/layout4.jpg'
                                ],
                                '5' => [
                                    'label' => esc_html__('Layout 5', 'roofex' ),
                                    'image' => get_template_directory_uri() . '/elements/templates/pxl_team_grid/layout-image/layout5.jpg'
                                ],
                            ],
                        ),
                    ),
